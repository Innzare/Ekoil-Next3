      ...
      >
        ...
        <Box>
          ...
          <Typography variant="h6" color="#6c6c6c" fontWeight="500" sx={{ lineHeight: 1.5 }}>
            Ekoil Lubricants основан в 1995 году и первоначально занималась научно-исследовательской деятельностью в
            сфере нефтехимии. По мере накопления базы знаний и опыта в данной сфере начали формироваться первые
            предложения продуктовой линейки смазочных материалов, соответствующие запросу рынка того времени. Год за
            годом Компания осваивала производство различных видов смазочных материалов, используя инновационные методики
            и опираясь на разработки ведущих производителей.
          </Typography>
