  ...
  const [accordions, setAccordions] = useState([
    {
      ...
      text: 'Масла EKOIL LUBRICANTS разрабатываются с учётом современных требований ведущих производителей техники, а также поставляются на конвейеры отечественных автопроизводителей.'
    },
    {
      id: 2,
      expanded: false,
